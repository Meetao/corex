	...
	<div id="siteproductBasisSiteManage">
		<div class="co-wapper">
			...
			<div class="searchBox">
				<el-form :inline="true" class="demo-form-inline" size="small">
					<el-form-item label="品种">
						<el-select v-model="formInline.type" clearable placeholder="请选择">
							<el-option v-for="item in brandTypes"
									   :key="item.value"
									   :value="item.value"
									   :label="item.text">
							</el-option>
				...
				<el-table :data="tableData3.slice((pageNo - 1) * pageSize,pageNo * pageSize)" stripe style="width: 100%" :header-cell-style="{'text-align':'center'}" :cell-style="{'padding':'8px'}" :height="tableHeight">
					...
					<el-table-column prop="onPortPrice" label="现汇含税湿吨车板（元/湿吨）" width="298" align="center"></el-table-column>
				</el-table>
				<el-pagination
...
<script>
	export default {
		...
		methods:{
			getTableData(){
				var _this = this;
				this.$axios.get('data/productBasis')
					.then(function (res) {
