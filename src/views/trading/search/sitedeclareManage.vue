	...
	<div id="sitedeclareManage">
		<div class="co-wapper">
			<el-breadcrumb separator-class="el-icon-arrow-right">
				...
				<el-breadcrumb-item>申报查询</el-breadcrumb-item>
			</el-breadcrumb>
			<div class="searchBox">
				...
				<el-table :data="tableData2.slice((pageNo - 1) * pageSize,pageNo * pageSize)" stripe style="width: 100%" :header-cell-style="{'text-align':'center'}" :cell-style="{'padding':'4px 2px'}" :height="tableHeight">
					...
					<el-table-column prop="offerDate" label="申报时间" width="160" align="center"></el-table-column>
					<el-table-column prop="brand" label="交易标的" width="120" align="center"></el-table-column>
					<el-table-column prop="quantity" label="申报数量" width="100" align="center"></el-table-column>
					<el-table-column prop="price" label="申报价格" width="200" align="center"  show-overflow-tooltip></el-table-column>
					...
					<el-table-column prop="fe" label="操作" width="118" align="center">
						<template slot-scope="scope">
