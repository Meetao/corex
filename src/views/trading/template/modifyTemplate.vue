			...
			<div class="searchBox">
				<el-form :inline="true" class="demo-form-inline" size="small">
					<el-form-item label="买卖方向">
						<el-select v-model="formInline.dealType" clearable placeholder="请选择">
				...
				<el-table :data="tableData2.slice((pageNo - 1) * pageSize,pageNo * pageSize)" stripe style="width: 100%" :header-cell-style="{'text-align':'center'}" :cell-style="{'padding':'4px 2px'}" :height="tableHeight">
					<el-table-column fixed prop="tempName" label="模板名称" width="220" align="center"></el-table-column>
					<el-table-column prop="board.label" label="盘面" width="220" align="center"></el-table-column>
					<el-table-column prop="brand" label="交易标的" width="220" align="center"></el-table-column>
					...
					<el-table-column  label="操作" width="198" align="center">
						<template slot-scope="scope">
							<el-button @click.native.prevent="deleteRow(scope.row,tableData2)" type="text" size="small">
								删除
							</el-button>
...
<script>
	export default {
		...
		methods:{
			getTableData(){
				var _this = this;
				this.$axios.get('data/templateList')
					.then(function (res) {
			...
			deleteRow(row,data){
				var _this = this;
				console.log(row.id);
				this.$axios.post('data/deleteData',{
					params:{
						id:row.id,
						data:data
					}
