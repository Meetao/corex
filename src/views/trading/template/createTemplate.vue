	...
	<div id="createTemplate">
		<div class="co-wapper">
			<el-breadcrumb separator-class="el-icon-arrow-right">
				...
				<el-breadcrumb-item>新建模板</el-breadcrumb-item>
			</el-breadcrumb>

			<el-form ref="formDate" :model="formData" label-width="110px" size="small">
				<el-form-item label="模板名称">
					<el-input v-model="formData.tempOption" style="width: 280px;"></el-input>
				</el-form-item>
				<el-form-item label="申报盘面">
					<el-radio v-model="formData.board" v-for="item in boards" :key="item.value" :label="item.text"></el-radio>
				</el-form-item>
					...
					<el-col :span="12">
						<el-form-item label="产地">
							<el-select v-model="formData.origin" placeholder="请选择">
								<el-option v-for="item in origins" :key="item" :label="item" :value="item"></el-option>
							</el-select>
						</el-form-item>
					</el-col>
				</el-row>
					...
					<el-col :span="12">
						<el-form-item label="交货期">
							<el-select v-model="formData.deliveryPeriod" placeholder="请选择">
								<el-option v-for="item in deliveryPeriods" :key="item" :label="item" :value="item"></el-option>
							</el-select>
						</el-form-item>
				...
				<el-row>
					<el-col :span="12">
						<el-form-item>
							<el-button type="primary" @click="dialogFormVisible1 = true">确认匹配</el-button>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="运费差">
							<el-button type="primary" @click="dialogFormVisible2 = true">填报</el-button>
							&nbsp;&nbsp;基港：青岛
						</el-form-item>
					</el-col>
				</el-row>
				...
				<el-dialog title="请填写运费差" :visible.sync="dialogFormVisible2" >
					...
					<el-table :data="tableInit2" border style="width: 100%" size="small" :header-cell-style="{'text-align':'center','background':'#f5f7fa'}" >
						<el-table-column fixed prop="a" label="港口" align="center">
							<template slot-scope="scope">
								<el-form-item label-width="0">
									<el-select v-model="scope.row.value">
										<el-option v-for="item in deliveryPorts" :key="item.value" :value="item.value" :label="item.text"></el-option>
									</el-select>
								</el-form-item>
							</template>
						</el-table-column>
					...
					<div slot="footer" class="dialog-footer" style="text-align: center;">
						<el-button type="primary" @click="addFreightDifferential">增 加</el-button>
						<el-button type="primary" @click="dialogFormVisible2 = false">确 定</el-button>
						<el-button type="primary" @click="dialogFormVisible2 = true">重 置</el-button>

					</div>
				</el-dialog>

				<!--标的信息填报-->
				<el-table :data="tableInit" border style="width: 100%" :header-cell-style="{'text-align':'center','background':'#ecf5ff'}" >
					<el-table-column fixed prop="a" label="交易标的" width="200" align="center">
						<template slot-scope="scope">
							<el-form-item label-width="0">
								<el-select v-model="scope.row.value"  label-width="0">
									<el-option v-for="item in brands" :key="item.value" :value="item.value"></el-option>
								</el-select>
							</el-form-item>
						</template>
					</el-table-column>
					...
					<el-table-column label="属性"  align="center">
						<template slot-scope="scope">
							<el-form-item label-width="0">
								<el-button type="primary" @click="dialogFormVisible3 = true">填报</el-button>
							</el-form-item>
						</template>
					</el-table-column>
				</el-table>
				...
				<el-dialog title="请填写报价信息及相关属性信息" :visible.sync="dialogFormVisible3" width="80%" >
								...
								<el-col :span="8">
									<el-form-item label="结算依据" size="small">
										<el-select v-model="dialogData.settlementBasis">
											<el-option v-for="item in settlementBasis"
													   :key="item.value"
													   :label="item.label"
								...
								<el-col :span="8">
									<el-form-item label="计价周期" size="small">
										<el-select v-model="dialogData.quotationPeriod">
											<el-option v-for="item in quotationPeriods"
													   :key="item.value"
													   :label="item.label"
													   :value="item.value"></el-option>
										</el-select>
						...
						<div class="gongshi">
							<el-form-item  label="指数公式" size="small">
								<el-select v-model="dialogData.formula">
									<el-option v-for="item in formulas"
											   :key="item.value"
											   :label="item.label"
											   :value="item.value"></el-option>
								</el-select>
						...
						<div class="part4">
							<div>
								...
								<el-row>
									...
									<el-col :span="7">
										<el-form-item label="-1%" size="small">
											<el-input v-model="dialogData.Fe.c">
								...
								<el-row>
									...
									<el-col :span="7">
										<el-form-item label="-1%" size="small">
											<el-input v-model="dialogData.SiO2.c">
								...
								<el-row>
									...
									<el-col :span="7">
										<el-form-item label="-1%" size="small">
											<el-input v-model="dialogData.Al2O3.c">
								...
								<el-row>
									...
									<el-col :span="7">
										<el-form-item label="-1%" size="small">
											<el-input v-model="dialogData.S.c">
								...
								<el-row>
									...
									<el-col :span="7">
										<el-form-item label="-1%" size="small">
											<el-input v-model="dialogData.P.c">
								...
								<el-row>
									...
									<el-col :span="3">
										<el-button size="small" @click="moreProperties = !moreProperties">{{moreProperties==false?'+ 更多':'- 隐藏'}}</el-button>
									</el-col>
								</el-row>
							</div>
							<div v-show="moreProperties">
								<el-row>
									...
									<el-col :span="7">
										<el-form-item label="-1%" size="small">
											<el-input v-model="dialogData.Mn.c">
								...
								<el-row>
									...
									<el-col :span="7">
										<el-form-item label="-1%" size="small">
											<el-input v-model="dialogData.CaO.c">
								...
								<el-row>
									...
									<el-col :span="7">
										<el-form-item label="-1%" size="small">
											<el-input v-model="dialogData.K2O.c">
								...
								<el-row>
									...
									<el-col :span="7">
										<el-form-item label="-1%" size="small">
											<el-input v-model="dialogData.MgO.c">
								...
								<el-row>
									...
									<el-col :span="7">
										<el-form-item label="-1%" size="small">
											<el-input v-model="dialogData.Na2O.c">
								...
								<el-row>
									...
									<el-col :span="7">
										<el-form-item label="-1%" size="small">
											<el-input v-model="dialogData.TiO2.c">
					...
					<div slot="footer" class="dialog-footer" style="text-align: center;">
						...
						<el-button type="primary" @click="dialogFormVisible3 = true">重 置</el-button>
					</div>
				</el-dialog>
	...
	export default {
		data(){
			...
			return {
				...
				origins:['澳大利亚','巴西','印度','南非','俄罗斯','乌克兰','加拿大','伊朗','其他'],
				deliveryPeriods:['装船期','提单日','到港期','月到港(1船/月)','其他约束条款'],
				brands:[
					{
						text:'PB粉',
						value:'PB粉'
...
<style scoped>
	...
	/*属性信息填报弹窗*/
	.floatPrice,.properties{
		border: 1px solid #cacaca;
		border-bottom: 0;
	}
	.floatPrice-tit,.properties-tit{
		background: #f5f7fa;
		height: 30px;
		line-height: 30px;
		margin-bottom: 22px;
