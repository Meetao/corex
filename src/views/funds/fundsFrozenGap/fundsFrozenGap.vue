<template>
	<div id="fundsFrozenGap">
		<div class="co-wapper">
			...
			<div class="searchBox">
				<el-table :data="tableData.slice((pageNo - 1) * pageSize,pageNo * pageSize)" stripe show-summary style="width: 100%" :header-cell-style="{'text-align':'center'}" :cell-style="{'padding':'8px'}" :height="tableHeight">
					...
					<el-table-column label="已冻结金额" width="300" align="center">
						<el-table-column prop="peormanceBond_A" label="履约保证金冻结" width="150" align="center"></el-table-column>
						<el-table-column prop="floatingLosses_A" label="浮亏冻结" width="150" align="center"></el-table-column>
					</el-table-column>
					<el-table-column label="应冻结金额" width="300" align="center">
						<el-table-column prop="peormanceBond_B" label="履约保证金冻结" width="150" align="center"></el-table-column>
						<el-table-column prop="floatingLosses_B" label="浮亏冻结" width="150" align="center"></el-table-column>
					</el-table-column>
					<el-table-column prop="differential" label="每单应冻结差额" width="120" align="center"></el-table-column>
					<el-table-column prop="frozenForRiskControl" label="风险资金冻结" width="120" align="center"></el-table-column>
