<template>
	<div id="lastQuotationalDay">
		<div class="co-wapper">
			<el-breadcrumb separator-class="el-icon-arrow-right">
				<el-breadcrumb-item :to="{ path: '/' }">首页</el-breadcrumb-item>
				<el-breadcrumb-item>在线通知</el-breadcrumb-item>
				<el-breadcrumb-item>最后点价日</el-breadcrumb-item>
			</el-breadcrumb>
			<div class="searchBox">
				...
				<el-table :data="tableData.slice((pageNo - 1) * pageSize,pageNo * pageSize)" stripe style="width: 100%" :header-cell-style="{'text-align':'center'}" :cell-style="{'padding':'8px'}" :height="tableHeight">
					...
					<el-table-column prop="date" label="发布时间" width="400" align="center"></el-table-column>
					<el-table-column prop="title" label="标题" width="300" align="center"></el-table-column>
					<el-table-column prop="status" label="状态" width="318" align="center"></el-table-column>
				</el-table>
				<div class="readedBtn">
		...
		methods:{
			...
			handleSizeChange(val) {  //分页
				...
				if(this.totalDataNumber>this.pageSize){
					...
					this.tableHeight = (40*this.totalDataNumber +40)+'px';
				}
			},
