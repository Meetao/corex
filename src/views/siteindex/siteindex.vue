			...
			<div class="co-wapper">
				...
				<el-tabs type="border-card" v-model="activeName" @tab-click="handleClick">
					<el-tab-pane label="今日成交" name="one">
						...
						<el-table :data="tableData1" stripe style="width: 100%" max-height="250" :header-cell-style="{'text-align':'center'}" :cell-style="{'padding':'4px 2px'}">
							<el-table-column fixed prop="board.value" label="盘面" width="60" align="center"></el-table-column>
							...
							<el-table-column prop="deliveryPeriod" label="交货期" width="180" align="center" show-overflow-tooltip></el-table-column>
							<el-table-column prop="deliveryPort" label="交货地" width="100" align="center"></el-table-column>
							<el-table-column prop="price" label="成交价" width="288" align="center"  show-overflow-tooltip></el-table-column>
							<el-table-column prop="quantity" label="成交量(湿吨)" width="100" align="center"></el-table-column>
							<el-table-column fixed="right" label="详情" width="70" align="center">
								<template slot-scope="scope">
									<el-button @click.native.prevent="deleteRow(scope.$index, tableData1)" type="text" size="small">
										查看
									</el-button>
								</template>
							</el-table-column>
					...
					<el-tab-pane label="成交查询" name="two">
						...
						<el-form :inline="true" class="demo-form-inline" size="mini">
							<el-form-item label="交易盘面">
								<el-select v-model="formInline.board" clearable placeholder="请选择">
									<el-option v-for="item2 in boards"
											   :key="item2.value" :value="item2.value" :label="item2.label">
									</el-option>
								</el-select>
							</el-form-item>
							<el-form-item  label="交易标的">
								<el-select v-model="formInline.brand" clearable placeholder="请选择">
									<el-option v-for="item3 in brands"
											   :key="item3.value"
											   :label="item3.label"
											   :value="item3.value">
									</el-option>
							...
							<el-form-item label="成交日期">
								<el-date-picker
										v-model="formInline.tradingDate"
										type="daterange"
										align="right"
										unlink-panels
										range-separator="至"
						...
						<!--历史成交列表-->
						<el-table :data="tableData3.slice((pageNo - 1) * pageSize,pageNo * pageSize)" stripe style="width: 100%"  :height="tableHeight" :header-cell-style="{'text-align':'center'}" :cell-style="{'padding':'4px 2px'}">
							...
							<el-table-column prop="brand" label="交易标的" width="120" align="center"></el-table-column>
							<el-table-column prop="deliveryPeriod" label="交货期" width="140" align="center" show-overflow-tooltip></el-table-column>
							<el-table-column prop="deliveryPort" label="交货地" width="80" align="center"></el-table-column>
							<el-table-column prop="price" label="成交价" width="200" align="center"  show-overflow-tooltip></el-table-column>
							<el-table-column prop="fe" label="Fe(%)" width="60" align="center"></el-table-column>
							<el-table-column prop="quantity" label="成交量(湿吨)" width="100" align="center"></el-table-column>
							<el-table-column prop="tradingDate" label="成交日期" width="168" align="center"></el-table-column>
			...
			<div class="co-wapper">
				<el-tabs type="border-card">
					<el-tab-pane label="今日申报">
						...
						<!--条件筛选 end-->
						<!--今日申报列表 begin-->
						<el-table :data="tableData2" stripe style="width: 100%" :header-cell-style="{'text-align':'center'}" :cell-style="{'padding':'4px 2px'}">
							<el-table-column fixed prop="board.value" label="盘面" width="60" align="center"></el-table-column>
							<el-table-column prop="brand" label="交易标的" width="120" align="center"></el-table-column>
							<el-table-column prop="deliveryPeriod" label="交货期" width="170" align="center"  show-overflow-tooltip></el-table-column>
							<el-table-column prop="deliveryPort" label="交货地" width="100" align="center"></el-table-column>
							<el-table-column prop="bidPrice" label="买价" width="220" align="center"  show-overflow-tooltip></el-table-column>
							<el-table-column prop="askPrice" label="卖价" width="220" align="center"  show-overflow-tooltip></el-table-column>
							<el-table-column prop="quantity" label="申报量(湿吨)" width="100" align="center"></el-table-column>
							<el-table-column fixed="right" label="详情" width="70" align="center">
								<template slot-scope="scope">
